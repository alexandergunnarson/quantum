...
#_(defn tweets [user-id & [{:keys [cursor parse? handlers keys-fn] :as opts} email app]]
  (request! email app
...
#_(defn rate-limits [& [{:keys [parse? handlers keys-fn] :as opts} email app]]
  (request! email app
...
#_(defn followers:list [user-id & [{:keys [cursor parse? handlers keys-fn] :as opts} email app]]
  (request! email app
...
#_(defn user:id->followees:ids [user-id & [{:keys [cursor parse? handlers keys-fn] :as opts} email app]]
...
#_(defn user:id->followers:ids [user-id & [{:keys [cursor parse? handlers keys-fn] :as opts} email app]]
  (request! email app
...
#_(defn user:id->metadata [user-id & [{:keys [cursor parse? handlers keys-fn] :as opts} email app]]
  (request! email app
...
#_(defn user:ids->metadata [user-ids & [{:keys [cursor parse? handlers keys-fn] :as opts} email app]]
...
#_(defn post-status! [status & [{:keys [parse? handlers keys-fn] :as opts} email app]]
...
#_(defn tweets-and-user [user-id]
