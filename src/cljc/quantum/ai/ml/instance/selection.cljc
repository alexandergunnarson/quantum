...
(defn drop-3
  "DROP (Decremental Reduction Optimization Procedure) 3.
   ...
   This is the instance selection algorithm with the best compression ratio.
   It is not suitable for big data due to its algorithmic complexity.
   Prefer LSH-IS-F in all cases."
  {:algorithm   "Wilson, Martinez: 'Instance pruning techniques' (1997)"
   :complexity  "O(n^2)"
