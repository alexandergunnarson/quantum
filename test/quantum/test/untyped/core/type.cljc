...
(t/def i|>a+b  (t/isa? i.>a+b))
(t/def i|>a0   (t/isa? i.>a0))
(t/def i|>a1   (t/isa? i.>a1))
(t/def i|>b0   (t/isa? i.>b0))
(t/def i|>b1   (t/isa? i.>b1))
(t/def i|a     (t/isa? i.a))
(t/def i|b     (t/isa? i.b))
(t/def i|<a+b  (t/isa? i.<a+b))
(t/def i|<a0   (t/isa? i.<a0))
...
(do (t/def >a+b (t/isa? java.util.AbstractCollection))
    (t/def >a   (t/isa? java.util.AbstractList))
    (t/def >b   (t/isa? java.util.AbstractSet))
    (t/def a    (t/isa? java.util.ArrayList))
    (t/def b    (t/isa? java.util.HashSet))
    (t/def <a0  (t/isa? javax.management.AttributeList))
    (t/def <a1  (t/isa? javax.management.relation.RoleList))
    (t/def <b0  (t/isa? java.util.LinkedHashSet))
    (t/def <b1  (t/isa? javax.print.attribute.standard.JobStateReasons))
    (t/def ><0  byte?)
    (t/def ><1  short?)
    (t/def ><2  long?))

(t/def Uc (t/isa? java.lang.Object))
...
(deftest test|meta-or
  ...
  (testing "+ `t/-`"
    (is= (t/- (t/meta-or [i|a i|b]) i|><0)
         (t/meta-or [(t/- i|a i|><0) (t/- i|b i|><0)]))
    (is= (t/- i|><0 (t/meta-or [i|a i|b]))
         (t/meta-or [(t/- i|><0 i|a) (t/- i|><0 i|b)]))
    (is= (t/- (t/meta-or [i|a i|b]) (t/meta-or [i|><0 i|><1]))
         (t/meta-or [(t/- i|a i|><0) (t/- i|a i|><1) (t/- i|b i|><0) (t/- i|b i|><1)])))
